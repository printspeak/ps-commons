  ...
  action do
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        main_story:                 'As a developer, I want to isolate and test a common library of code, used by PrintSpeak, so that we can build better abstractions.',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/ps-commons'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'ps-commons'
